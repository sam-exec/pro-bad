...
export const INITIAL_KIDS_1ON1_STUDENTS: Kids1on1Student[] = [
  ...
  },
  {
    ...
    year: 2026,
    status: "Active",
    remarks: "Excellent smash accuracy. Ready for next package.",
    branchId: "branch-nlg",
    branchName: "Nallagandla",
    employeeId: "NLG004",
    employeeName: "Rahul Sharma",
...
export const INITIAL_ADULTS_COACHING_MEMBERS: AdultCoachMember[] = [
  ...
  },
  {
    ...
    year: 2026,
    status: "Active",
    remarks: "Awaiting corporate reimbursement voucher.",
    branchId: "branch-nlg",
    branchName: "Nallagandla",
    employeeId: "NLG004",
    employeeName: "Rahul Sharma",
