...
export const INITIAL_KIDS_STUDENTS: Student[] = [
  // --- Nallagandla Branch Records (NLG004 - Rahul Sharma) ---
  {
    ...
    year: 2026,
    status: "Active",
    remarks: "Excellent smash technique, participating in Junior U-11 tournaments.",
    branchId: "branch-nlg",
  ...
  },
  {
    ...
    year: 2026,
    status: "Active",
    remarks: "Enrolled in regular morning batch.",
    branchId: "branch-nlg",
    branchName: "Nallagandla",
    employeeId: "NLG004",
    employeeName: "Rahul Sharma",
  ...
  },
  {
    ...
    year: 2026,
    status: "Inactive",
    remarks: "Inactive. Follow up for admission next month.",
    branchId: "branch-mnk",
    branchName: "Manikonda",
    employeeId: "MNK001",
    employeeName: "Vikram Reddy",
